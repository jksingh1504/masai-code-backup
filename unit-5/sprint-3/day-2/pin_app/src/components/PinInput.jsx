...
const PinInput = ({ length,inputLength }) => {
	...
	return (
		<div>
			{Input.current.map((ele, indx) => 
				<InputCell inputLength={inputLength} setEnteredPin={setEnteredPin} key={indx} indx={indx} ref={(element)=>{Ref.current[indx]=element}} setcurntRef={setcurntRef} Ref={Ref} />
			)}
